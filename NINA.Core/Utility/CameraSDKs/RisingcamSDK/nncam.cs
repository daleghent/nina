...
public class Nncam : IDisposable {
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = cc), Obsolete("Use Nncam_EnumV2")]
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = cc)]
    private static extern int Nncam_PullImageV2(SafeCamHandle h, [Out] ushort[] pImageData, int bits, out FrameInfoV2 pInfo);
    ...
    */
    ...
    private static Dictionary<int, Nncam> _map = new Dictionary<int, Nncam>();
    ...
    */
    ...
    /* get the version of this dll/so, which is: 48.18332.20210120 */
    ...
    */
    ...
    public bool StartPullModeWithCallback(DelegateEventCallback edelegate) {
        ...
        if (edelegate != null) {
            ...
            return (Nncam_StartPullModeWithCallback(_handle, _pEventCallback, _id) >= 0);
        } else {
    ...
    */
    ...
    public bool StartPushModeV3(DelegateDataCallbackV3 ddelegate, DelegateEventCallback edelegate) {
        ...
        _pEventCallback = new EVENT_CALLBACK(EventCallback);
        return (Nncam_StartPushModeV3(_handle, _pDataCallbackV3, _id, _pEventCallback, _id) >= 0);
    }
    ...
    */
    ...
    public bool get_FinalSize(out int nWidth, out int nHeight) {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return (Nncam_get_FinalSize(_handle, out nWidth, out nHeight) >= 0);
    }
    ...
    */
    ...
    public bool put_RealTime(int val) {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return (Nncam_put_RealTime(_handle, val) >= 0);
    }
    ...
    public bool get_RealTime(out int val) {
        ...
        return (Nncam_get_RealTime(_handle, out val) >= 0);
    }
    ...
    public bool put_LevelRangeV2(ushort mode, int roiX, int roiY, int roiWidth, int roiHeight, ushort[] aLow, ushort[] aHigh) {
        ...
        return (Nncam_put_LevelRangeV2(_handle, mode, ref rc, aLow, aHigh) >= 0);
    }
    ...
    public bool get_LevelRangeV2(out ushort mode, out int roiX, out int roiY, out int roiWidth, out int roiHeight, ushort[] aLow, ushort[] aHigh) {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        RECT rc = new RECT();
        if (Nncam_get_LevelRangeV2(_handle, out mode, out rc, aLow, aHigh) < 0)
            return false;
        roiX = rc.left;
        roiY = rc.top;
    ...
    */
    ...
    public bool AwbOnce() {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return (Nncam_AwbOnce(_handle, IntPtr.Zero, IntPtr.Zero) >= 0);
    }
    ...
    public bool AbbOnce() {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return (Nncam_AbbOnce(_handle, IntPtr.Zero, IntPtr.Zero) >= 0);
    }
    ...
    public bool FfcOnce() {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return (Nncam_FfcOnce(_handle) >= 0);
    }
    ...
    public bool DfcOnce() {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return (Nncam_DfcOnce(_handle) >= 0);
    }
    ...
    public bool GetHistogram(DelegateHistogramCallback fnHistogramProc) {
        ...
        return (Nncam_GetHistogram(_handle, _pHistogramCallback, _id) >= 0);
    }
