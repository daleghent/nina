...
namespace NINA.Utility {
    public static class Utility {
        ...
        public static void saveFits(ImageArray iarr, string path, string imagetype, double duration, string filter, Model.AscomCameraModel.BinningMode binning, double temp) {
            try {
                Header h = new Header();
