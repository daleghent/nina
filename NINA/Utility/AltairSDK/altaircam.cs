...
namespace Altair
{
    ...
    {
        [DllImport("altaircam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall)]
    ...
    public class AltairCam : IDisposable
    {
        ...
        [DllImport("altaircam.dll", ExactSpelling = true, CallingConvention = CallingConvention.StdCall), Obsolete("Use Altaircam_EnumV2")]
