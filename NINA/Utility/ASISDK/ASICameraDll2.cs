...
{
    public static partial class ASICameraDll
    {
        ...
        public static void SetROIFormat(int cameraId, System.Drawing.Size size, int bin, ASI_IMG_TYPE imageType)
        {
        ...
        {
            CheckReturn(ASISetStartPos(cameraId, (int)startPos.X, (int)startPos.Y), MethodBase.GetCurrentMethod(), cameraId, startPos);
        }
