...
namespace NINA.Utility.AtikSDK {
    ...
    internal class AtikCameraDll {
        ...
        public static async Task<ImageArray> DownloadExposure(IntPtr camera, bool isBayered, bool calculateStatistics, int histogramResolution) {
            ...
            return await ImageArray.CreateInstance(arr, w, h, isBayered, calculateStatistics, histogramResolution);
        }
