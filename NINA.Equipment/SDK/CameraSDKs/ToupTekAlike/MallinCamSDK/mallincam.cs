    ...
    */
    public class MallinCam : IDisposable {
        ...
        public enum eEVENT : uint {
            ...
            EVENT_IMAGE = 0x0004, /* live image arrived, use Mallincam_PullImage to get this image */
            EVENT_STILLIMAGE = 0x0005, /* snap (still) frame arrived, use Mallincam_PullStillImage to get this frame */
        ...
        public struct ModelV2 {
            ...
            public ulong flag;          /* MALLINCAM_FLAG_xxx, 64 bits */
        ...
        */
        ...
        public static MallinCam Open(string id) {
            SafeCamHandle tmphandle = Mallincam_Open(id);
        ...
        */
        ...
        public bool IoControl(uint ioLineNumber, eIoControType eType, int outVal, out int inVal) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_IoControl(handle_, ioLineNumber, eType, outVal, out inVal));
        }
        ...
        public bool get_AfParam(out AfParam pAfParam) {
            ...
            if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
                return false;
            return CheckHResult(Mallincam_get_AfParam(handle_, out pAfParam));
        }
        ...
        public bool GetHistogram(DelegateHistogramCallback funHistogram) {
            ...
            return CheckHResult(Mallincam_GetHistogram(handle_, pHistogram_, id_));
        }
    ...
    private const UnmanagedType ut = UnmanagedType.LPStr;
        ...
        */
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern uint Mallincam_get_MaxBitDepth(SafeCamHandle h);/* get the max bit depth of this camera, such as 8, 10, 12, 14, 16 */
        ...
        */
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_GetHistogram(SafeCamHandle h, HISTOGRAM_CALLBACK funHistogram, IntPtr ctxHistogram);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_IoControl(SafeCamHandle h, uint ioLineNumber, eIoControType eType, int outVal, out int inVal);

        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_get_AfParam(SafeCamHandle h, out AfParam pAfParam);
        ...
        [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
        private static extern int Mallincam_Replug([MarshalAs(ut)] string id);
