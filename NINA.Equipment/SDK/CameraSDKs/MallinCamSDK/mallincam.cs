...
namespace MallinCam {
    /*
        Versin: 49.18608.20210313

        For Microsoft dotNET Framework & dotNet Core

        We use P/Invoke to call into the mallincam.dll API, the c# class Toupcam is a thin wrapper class to the native api of mallincam.dll.
    ...
    */
    ...
    public class SafeCamHandle : SafeHandle
    {
        ...
        */
        ...
        private static Dictionary<int, MallinCam> _map = new Dictionary<int, MallinCam>();
        ...
        */
        ...
        /* get the version of this dll/so, which is: 49.18608.20210313 */
        ...
        */
        ...
        public bool put_LevelRangeV2(ushort mode, int roiX, int roiY, int roiWidth, int roiHeight, ushort[] aLow, ushort[] aHigh) {
            ...
            return (Toupcam_put_LevelRangeV2(_handle, mode, ref rc, aLow, aHigh) >= 0);
        }
        ...
        public bool get_LevelRangeV2(out ushort mode, out int roiX, out int roiY, out int roiWidth, out int roiHeight, ushort[] aLow, ushort[] aHigh) {
            ...
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            RECT rc = new RECT();
            if (Toupcam_get_LevelRangeV2(_handle, out mode, out rc, aLow, aHigh) < 0)
                return false;
            roiX = rc.left;
            roiY = rc.top;
        ...
        */
        ...
        public bool AwbOnce() {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Toupcam_AwbOnce(_handle, IntPtr.Zero, IntPtr.Zero) >= 0);
        }
        ...
        public bool AbbOnce() {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Toupcam_AbbOnce(_handle, IntPtr.Zero, IntPtr.Zero) >= 0);
        }
        ...
        public bool FfcOnce() {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Toupcam_FfcOnce(_handle) >= 0);
        }
        ...
        public bool DfcOnce() {
            if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
                return false;
            return (Toupcam_DfcOnce(_handle) >= 0);
        }
