...
public class Nncam : IDisposable {
    ...
    /* get the version of this dll/so, which is: 52.20594.20220401 */
    ...
    */
    ...
    public bool StartPushModeV3(DelegateDataCallbackV3 funDataV3, DelegateEventCallback funEvent) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;

        funDataV3_ = funDataV3;
        funEvent_ = funEvent;
        pDataV3_ = delegate (IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr ctxDataV3) {
            Object obj = null;
            if (map_.TryGetValue(ctxDataV3.ToInt32(), out obj) && (obj != null)) {
    ...
    */
    ...
    public bool put_MaxAutoExpoTimeAGain(uint maxTime, ushort maxAGain) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Nncam_put_MaxAutoExpoTimeAGain(handle_, maxTime, maxAGain));
    }
    ...
    public bool get_MaxAutoExpoTimeAGain(out uint maxTime, out ushort maxAGain) {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Nncam_get_MaxAutoExpoTimeAGain(handle_, out maxTime, out maxAGain));
    }

    public bool put_MinAutoExpoTimeAGain(uint minTime, ushort minAGain) {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Nncam_put_MinAutoExpoTimeAGain(handle_, minTime, minAGain));
    }
    ...
    public bool get_MinAutoExpoTimeAGain(out uint minTime, out ushort minAGain) {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Nncam_get_MinAutoExpoTimeAGain(handle_, out minTime, out minAGain));
    }
    ...
    public bool get_ExpoAGain(out ushort AGain)/* percent, such as 300 */
    {
        ...
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Nncam_get_ExpoAGain(handle_, out AGain));
    }
    ...
    public bool put_ExpoAGain(ushort AGain)/* percent */
    {
        if (handle_ == null || handle_.IsInvalid || handle_.IsClosed)
            return false;
        return CheckHResult(Nncam_put_ExpoAGain(handle_, AGain));
    }
    ...
    */
    ...
    public bool GetHistogram(DelegateHistogramCallback funHistogram) {
        ...
        return CheckHResult(Nncam_GetHistogram(handle_, pHistogram_, id_));
    }
    ...
    */
    ...
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    private delegate void DATA_CALLBACK_V3(IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr ctxDataV3);
    [UnmanagedFunctionPointer(CallingConvention.Winapi)]
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi), Obsolete("Use Nncam_EnumV2")]
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_StartPushModeV3(SafeCamHandle h, DATA_CALLBACK_V3 funDataV3, IntPtr ctxDataV3, EVENT_CALLBACK funEvent, IntPtr ctxEvent);
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    ...
    */
    ...
    [DllImport(DLLNAME, ExactSpelling = true, CallingConvention = CallingConvention.Winapi)]
    private static extern int Nncam_GetHistogram(SafeCamHandle h, HISTOGRAM_CALLBACK funHistogram, IntPtr ctxHistogram);
