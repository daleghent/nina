...
namespace NINA.Equipment.Equipment.MyCamera {
    public class ASTPANCamera : BaseINPC, ICamera {
        private IASTPANSDK sdk;
        private IProfileService profileService;
        private readonly IExposureDataFactory exposureDataFactory;

        public ASTPANCamera(int id, string name, string driverVersion, IASTPANSDK sdk, IProfileService profileService, IExposureDataFactory exposureDataFactory) {
            this.Name = name;
            this.sdk = sdk;
            this.Category = "AstpanCam";
            this.Description = "Native driver implementation for AstpanCam Cameras";
            this.DriverInfo = "AstpanCam native driver";
